...
export default class RoomList2 extends React.Component<IProps, IState> {
    private sublistRefs: { [tagId: string]: React.Ref<RoomSublist2> } = {};
    ...
    private prepareLayouts() {
        this.unfilteredLayout = new Layout((tagId: string, height: number) => {
            ...
            if (sublist) sublist.setHeight(height);
    ...
    private collectSublistRef(tagId: string, ref: React.Ref<RoomSublist2>) {
        if (!ref) {
