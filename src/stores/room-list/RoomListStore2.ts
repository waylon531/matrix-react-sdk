...
import { OrderedDefaultTagIDs, Category, DefaultTagID, ListAlgorithm, SortAlgorithm, TagID } from "./models";
...
class _RoomListStore extends Store<ActionPayload> {
    ...
    public get orderedLists(): {[tagId in TagID]: Room[]} {
    ...
    private setAlgorithmClass() {
        // TODO: Figure out the class implementation to use
    }

    private regenerateAllLists() {
        console.log("REGEN");
        const tags: {[tagId in TagID]: SortAlgorithm} = {};
